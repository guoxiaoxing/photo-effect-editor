...
import com.guoxiaoxing.editor.process.effect.AverageSmoothTransformation;
import com.guoxiaoxing.editor.process.effect.BrightnessTransformation;
import com.guoxiaoxing.editor.process.effect.ColorBostUpTransformation;
import com.guoxiaoxing.editor.process.effect.ContrastTransformation;
import com.guoxiaoxing.editor.process.effect.EffectCreator;
import com.guoxiaoxing.editor.process.effect.EffectTransformation;
import com.guoxiaoxing.editor.process.effect.EmbossTransformation;
import com.guoxiaoxing.editor.process.effect.EngravingTransformation;
import com.guoxiaoxing.editor.process.effect.FlippingTransformation;
import com.guoxiaoxing.editor.process.effect.GammaCorrectionTransformation;
import com.guoxiaoxing.editor.process.effect.GaussianBlurTransformation;
import com.guoxiaoxing.editor.process.effect.GrayscaleTransformation;
import com.guoxiaoxing.editor.process.effect.HDRTransformation;
import com.guoxiaoxing.editor.process.effect.HisEqualTransformation;
import com.guoxiaoxing.editor.process.effect.InvertTransformation;
import com.guoxiaoxing.editor.process.effect.LeftRightMotionBlurTransformation;
import com.guoxiaoxing.editor.process.effect.LomoEffectTransformation;
import com.guoxiaoxing.editor.process.effect.NeonEffectTransformation;
import com.guoxiaoxing.editor.process.effect.RomanticEmbossTransformation;
import com.guoxiaoxing.editor.process.effect.SaturationTransformation;
import com.guoxiaoxing.editor.process.effect.SharpenTransformation;
import com.guoxiaoxing.editor.process.effect.SketchEffectTransformation;
import com.guoxiaoxing.editor.process.effect.SmoothTransformation;
import com.guoxiaoxing.editor.process.effect.SoftGlowEffectTransformation;
import com.guoxiaoxing.editor.process.effect.TVTransformation;
